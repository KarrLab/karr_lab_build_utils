...
import re
filename = os.path.join(os.path.dirname(__file__), "..", "{{ package }}", "_version.py")
...
#
# html_title = u'{{ package }} v{{ version }}'
...
addmetahtml_content = '<meta http-equiv="refresh" content="0; url=https://docs.karrlab.org/{{ package }}" />'
