...
import re
filename = os.path.join(os.path.dirname(__file__), "..", "karr_lab_build_utils", "_version.py")
...
def linkcode_resolve(domain, info):
    ...
    if os.path.isfile(os.path.join(os.path.dirname(__file__), '..', rel_filename + '.py')):
        return "https://github.com/KarrLab/karr_lab_build_utils/blob/master/{}.py".format(rel_filename)
    else:
        return "https://github.com/KarrLab/karr_lab_build_utils/blob/master/{}/__init__.py".format(rel_filename)
...
addmetahtml_content = '<meta http-equiv="refresh" content="0; url=https://docs.karrlab.org/karr_lab_build_utils" />'
