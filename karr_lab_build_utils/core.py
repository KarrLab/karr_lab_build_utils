...
class BuildHelper(object):
    ...
    * Archive reports to lab server, Coveralls, and Code Climate
    ...
    Attributes:
        ...
        DEFAULT_PROJ_TESTS_NOSE_LATEST_FILENAME (:obj:`str`): default file name to store latest XML test report
        DEFAULT_PROJ_TESTS_NOSE_DIR (:obj:`str`): default local directory where the test reports generated by nose should be saved
        ...
        DEFAULT_SERV_TESTS_NOSE_DIR (:obj:`str`): default server directory where the test reports generated by nose should be saved
